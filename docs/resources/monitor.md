...
- `url` (String) URL to monitor. Required for all monitor types **except** HEARTBEAT.
...
- `heartbeat_url` (String) The heartbeat endpoint URL returned by UptimeRobot. **Only populated for `type = "HEARTBEAT"` monitors.** Use this value in your application to send periodic pings.
